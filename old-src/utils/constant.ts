...
export const urlImgObject = {
  Astroport: "/astroport.png",
  Stride: "/stride.png",
  Mars: "/redbank.png",
  Apollo: "/apollo.jpg",
};
...
export const urlObject = {
  Aether: "/Aether.svg",
  Composable: "/Composable.svg",
  EntryPoint: "/EntryPoint.svg",
  Neutron: "/Neutron.svg",
  Stride: "/Stride.svg",
};
...
export const ValidatorNames = [
  ...
  "🇨🇭 Vortex.live 🟢",
  "🌐 KysenPool Sky ☁️ ",
  "✅ CryptoCrew Validators 🏆 Winner #GameOfChains",
  "Twinstake",
  "#decentralizehk - DHK dao",
  "WeStaking",
  "HyperblocksPro",
  "Staked",
  "Binary Holdings",
  ...
  "🛡️Bunkerstake.io",
  "Meria",
  "HighStakes.ch | Stake for Airdrop",
  "EZ Staking",
  "StakeWithUs",
  "Enigma",
  "Cypher Core",
  ...
  "validator.network",
  "Umbrella ☔",
  "Cosmic Validator | 100% Uptime & Auto-compound",
  "HashKey Cloud",
  "Luganodes",
  "Leap Wallet",
  "DACM",
  ...
  "Moonlet",
  "ECO Stake 🌱",
  "Blocks United | blocksunited.com",
  "BitValidator",
  "Colossus",
  "Sygnum",
  "PUPMØS",
